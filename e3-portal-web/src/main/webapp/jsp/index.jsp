...
<div class="slide_show" id="slide_show">
	<div class="indexW">
      <div id="index_slide" class="slide_wrap">
		<ol>
			<c:forEach items="${ad1}" var="node" varStatus="status">
			<li>
...
<%--			</a></li>--%>
     ...
     <div class="rSide">	
      ...
      <ul class="none" id="lunboNum">
      			<c:forEach items="${ad1 }" varStatus="status">
...
<div class="indexW mt1">
	...
	<div class="rSide1">
    	...
    	<div class="rImg2">
      	<a name="sfbest_hp_hp_news_right-ad" class="trackref" href="/html/activity/1472464260.html" target="_blank"><img salt="9.2-9.5" src="${pageContext.request.contextPath}/images/goods/751d2091c008c2a49c1934545730f041.jpg"></a>
   		</div>
